// AGF Mobile Prototype 01 — camera
// Forked from AGF side-scroll seed. Behavior is identical; the seed's
// camera is fully driven by VIEW (w/h) and level.mapSize, both of which
// we control, so a single-file copy is the right move.
